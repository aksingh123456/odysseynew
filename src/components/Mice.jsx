    ...
    <div className="page">
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: Arial, sans-serif; }
        ...
        .hero { margin: 24px 40px; border-radius: 16px; overflow: hidden; position: relative; }
        ...
        .section { padding: 0 40px; margin-top: 24px; }
        .section h2 { font-size: 18px; margin-bottom: 8px; color: #111; }
        .section p { font-size: 14px; color: #555; max-width: 900px; }
        ...
        .cta img { width: 100%; height: 160px; object-fit: cover; }
